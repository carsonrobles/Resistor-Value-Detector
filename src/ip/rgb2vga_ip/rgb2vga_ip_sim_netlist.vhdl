...
-- Date        : Mon Nov 12 18:42:10 2018
-- Host        : ubuntu running 64-bit Ubuntu 16.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/carson/poly/cpe439/tmp/Resistor-Value-Detector/src/ip/rgb2vga_ip/rgb2vga_ip_sim_netlist.vhdl
-- Design      : rgb2vga_ip
...
entity rgb2vga_ip_rgb2vga is
  ...
  attribute ORIG_REF_NAME of rgb2vga_ip_rgb2vga : entity is "rgb2vga";
end rgb2vga_ip_rgb2vga;

architecture STRUCTURE of rgb2vga_ip_rgb2vga is
...
entity rgb2vga_ip is
  ...
  attribute NotValidForBitStream of rgb2vga_ip : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of rgb2vga_ip : entity is "rgb2vga_ip,rgb2vga,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of rgb2vga_ip : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of rgb2vga_ip : entity is "rgb2vga,Vivado 2018.2";
end rgb2vga_ip;

architecture STRUCTURE of rgb2vga_ip is
...
begin
U0: entity work.rgb2vga_ip_rgb2vga
     port map (
      PixelClk => PixelClk,
