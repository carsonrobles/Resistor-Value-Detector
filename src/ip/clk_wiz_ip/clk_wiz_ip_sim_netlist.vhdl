...
end clk_wiz_ip_clk_wiz_ip_clk_wiz;

architecture STRUCTURE of clk_wiz_ip_clk_wiz_ip_clk_wiz is
  signal clk_i_clk_wiz_ip : STD_LOGIC;
  signal clk_o_clk_wiz_ip : STD_LOGIC;
...
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      CLKIN1 => clk_i_clk_wiz_ip,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKOUT0 => clk_o_clk_wiz_ip,
...
begin
inst: entity work.clk_wiz_ip_clk_wiz_ip_clk_wiz
     port map (
      clk_i => clk_i,
      clk_o => clk_o,
      locked => locked,
