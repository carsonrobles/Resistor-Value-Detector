...
HD_PWD='/mnt/hgfs/Google Drive/poly/CPE439/Resistor-Value-Detector/project_1.runs/dvi2rgb_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dvi2rgb_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dvi2rgb_0.tcl
